...
namespace binary_test{
    ...
    std::string file1 = "binary_test1.dat";
    std::string file2 = "binary_test2.dat";
    ...
    void write(T& obj1, U& obj2){
        ...
        ofs1.open(file1, std::ios::binary);
        binary_serialize(obj1, ofs1);
        ofs1.close();

        ofs2.open(file2, std::ios::binary);
        binary_serialize(obj2, ofs2);
        ofs2.close();
    }
    ...
    void load(T& obj){
        ...
        if (choice == 1) {
            ifs1.open(file1, std::ios::binary);
            binary_deserialize(obj, ifs1);
            ifs1.close();
        } else if (choice == 2) {
            ifs2.open(file2, std::ios::binary);
            binary_deserialize(obj, ifs2);
            ifs2.close();
        }
    }
